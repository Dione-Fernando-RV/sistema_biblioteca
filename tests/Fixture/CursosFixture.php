...
class CursosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'situacao_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '1 - ativivo 2 - desativado', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'situacao_id' => 1,
                'cadastrado_por' => 1,
                'created' => '2021-07-18 21:09:30',
                'modeificado_por' => 1,
                'modified' => '2021-07-18 21:09:30',
            ],
        ];
        parent::init();
    }
