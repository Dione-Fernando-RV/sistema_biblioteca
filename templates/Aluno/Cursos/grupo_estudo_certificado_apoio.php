...
<!-- Pagina 1 -->
<section id="pagina1" style='background-image: url("<?= $this->Url->image('certificados/certificado_grupo_estudos.png') ?>");'>
  <!-- <?php echo $this->Html->image('certificados/certificado1.jpg', ['id' => 'certificado-background']); ?> -->
  <div id="conteudo">
    <?php echo $this->Html->image('certificados/certificado_grupo_estudos.png', ['id' => 'logo']); ?>
    <h3 class="titulo">certificado de conclusão GRUPO DE ESTUDOS</h3>
    <h4 class="titulo subtitulo">certificamos que</h4>
    <h1 class="titulo nome-aluno"><?= $alunos->nome ?></h1>
    <p><?= $cursos->descricao_certificado_voluntario ?></p>
    <div class="rodape">
      <div id="assinatura">
        <span></span>
        <p>CESAR MARTON</p>
