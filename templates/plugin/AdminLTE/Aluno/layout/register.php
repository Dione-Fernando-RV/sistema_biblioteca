...
<body class="hold-transition register-page" id="tudo">
  <div class="register-box login-content">
    <div class="register-logo cortextobranco">
      <a href="<?php echo $this->Url->build(); ?>" target="_blank" ><i class="cortextobranco"> <b>CEPEF</b></i></a>
        <!--
      <a href="<?php echo $this->Url->build(); ?>"  class="cortextobranco"><?php echo Configure::read('Theme.logo.large') ?></a>
      -->
    </div>

    <div>
      <p class="cortextobranco title-main">Preencha os campos abaixo
      </p>

      <?php echo $this->fetch('content'); ?>
      <!--
    <div class="social-auth-links text-center">class="register-box-body"
 ...
 -->
      <a href="<?php echo $this->Url->build(['prefix' => 'Aluno', 'controller' => 'Dashboard', 'action' => 'index']); ?>" class="text-center">
        <h4>Já possuo Cadastro</h4>
      </a>
    </div>
    <!-- /.form-box -->
  </div>
