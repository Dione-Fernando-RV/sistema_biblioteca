...
<head>
  ...
  <?php echo $this->Html->css('aluno/css/agenda'); ?>
...
<body class="hold-transition skin-<?php echo Configure::read('Theme.skin'); ?> sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo $this->Url->build('/'); ?>" class="logo">
        ...
        <span class="logo-mini"><i class="cortextobranco"> <b>CEPEF</b></i></span>
  ...
  <?php echo $this->Html->script('AdminLTE./bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.pt-BR.min', ['block' => 'script']); ?>
  <!-- Scripts -->
  <?php echo $this->Html->script('scripts', ['block' => 'script']); ?>
  <!-- Axios -->
  <?php echo $this->Html->script('axios.min', ['block' => 'script']); ?>
