      ...
      -->
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="hidden-xs">  <?= $_SESSION['Auth']['Aluno']['nome'] ?></span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            ...
            <li class="user-footer">
              <div class="pull-left">
              <a href="<?= $this->Url->build(['controller' => 'Usuarios', 'action' => 'edit', $_SESSION['Auth']['Aluno']['id']]) ?>" class="btn btn-default btn-flat">Meu Login</a>
              <a href="<?= $this->Url->build(['controller' => 'Alunos', 'action' => 'edit', $_SESSION['Auth']['Aluno']['aluno_id']]) ?>" class="btn btn-default btn-flat">Meu Cadastro</a>
